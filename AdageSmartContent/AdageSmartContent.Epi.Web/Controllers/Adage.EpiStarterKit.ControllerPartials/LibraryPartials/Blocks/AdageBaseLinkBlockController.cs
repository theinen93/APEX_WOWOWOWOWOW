...
{
    public partial class AdageLinkBlockController : AdageBaseBlockController<BaseLinkBlock>
    {
        #region Constructors
        public AdageLinkBlockController(IViewModelFactory viewModelFactory) : base(viewModelFactory)
        {
        }
        #endregion
